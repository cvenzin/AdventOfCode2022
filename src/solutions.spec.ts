...
`);
    ...
    it('day12', () => {
        const exampleInput = InputReader.readFile('src/inputs/day12_example.txt');
        const input = InputReader.readFile('src/inputs/day12.txt');
        expect(new Day12().part1(exampleInput)).toBe(31);
        expect(new Day12().part1(input)).toBe(484);
        expect(new Day12().part2(exampleInput)).toBe(29);
        expect(new Day12().part2(input)).toBe(478);
    });

    it('day13', () => {
        const exampleInput = InputReader.readFile('src/inputs/day13_example.txt');
        const input = InputReader.readFile('src/inputs/day13.txt');
        expect(new Day13().part1(exampleInput)).toBe(13);
    ...
    it('day18', () => {
        const exampleInput = InputReader.readFile('src/inputs/day18_example.txt');
        const input = InputReader.readFile('src/inputs/day18.txt');
        expect(new Day18().part1(exampleInput)).toBe(64);
        expect(new Day18().part1(input)).toBe(4300);
        expect(new Day18().part2(exampleInput)).toBe(58);
        expect(new Day18().part2(input)).toBe(2490);
    });

    it('day20', () => {
        const exampleInput = InputReader.readFile('src/inputs/day20_example.txt');
        const input = InputReader.readFile('src/inputs/day20.txt');
        expect(new Day20().part1(exampleInput)).toBe(3);
        expect(new Day20().part1(input)).toBe(7713);
        expect(new Day20().part2(exampleInput)).toBe(1623178306);
        expect(new Day20().part2(input)).toBe(1664569352803);
    });
});